            ...
            <div class="container mt-3 mb-4">
                ...
                <form action="{{ route('survey.submit') }}" method="POST" id="form-wrapper">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="code_student" id="ma_sv"
                                    value="{{ old('code_student') }}" oninput="setKhoaHocFromMaSV()">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="khoa_hoc" id="khoa_hoc"
                                    value="{{ old('khoa_hoc') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        @endforeach
                        <i class="question-10" style="font-size: 14px; color:rgb(94, 6, 6)"> *Nếu chưa có việc làm hoặc đang
                            tiếp tục học, anh/chị trả lời tiếp câu 27. Nếu đã có việc làm, anh/chị trả lời tiếp các câu
                            sau</i>
                    </div>
                    ...
                    <div class="employment-details">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Nhập tên công ty / tổ chức"
                                name="recruit_partner_name" value="{{ old('recruit_partner_name') }}">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control mb-1"
                                ...
                                value="{{ old('recruit_partner_address') }}">
                            <label class="form-label">Tỉnh/Thành phố</label>
                            <input type="text" class="form-control mb-1" placeholder="VD: Hà Nội"
                                name="recruit_partner_city" value="{{ old('recruit_partner_city') }}">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">14. Thời gian tuyển dụng</label>
                            <input type="date" class="form-control" name="recruit_partner_date"
                                value="{{ old('recruit_partner_date') }}">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">15. Chức vụ, vị trí việc làm</label>
                            <input type="text" class="form-control" placeholder="VD: Dev, BA, Design..."
                                name="recruit_partner_position" value="{{ old('recruit_partner_position') }}">
                        </div>
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold">25. Trong quá trình làm việc, Anh/Chị cần những kỹ năng mềm
                                nào sau đây? <span class="fw-normal">(Có thể chọn nhiều lựa chọn)</span></label>
                                ...
                                @if (mb_strtolower($value) == mb_strtolower('khác'))
                                    <div class="form-check mb-2">
                                        <input class="form-check-input soft_skills_required_other" type="checkbox"
                                            name="soft_skills_required[]" id="ht_kn_{{ $index }}"
                                            value="{{ $index }}">
                                        <label class="form-check-label fw-normal"
                                            for="ht_kn_{{ $index }}">Khác</label>
                                    </div>
                                @else
                                    <div class="form-check mb-2">
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold">26. Sau khi được tuyển dụng, Anh/Chị có phải tham gia khóa
                                học nâng cao nào dưới đây để đáp ứng công việc không <span class="fw-normal">(Có thể chọn
                                    nhiều lựa chọn)</span></label>
                                ...
                                @if (mb_strtolower($value) == mb_strtolower('khác'))
                                    <div class="form-check mb-2">
                                        <input class="form-check-input must_attended_courses_other" type="checkbox"
                                            name="must_attended_courses[]" id="ht_nc_{{ $index }}"
                                            value="{{ $index }}">
                                        <label class="form-check-label fw-normal"
                                            for="ht_nc_{{ $index }}">Khác</label>
                                    </div>
                                @else
                                    <div class="form-check mb-2">
                    ...
                    $(document).on('change', checkboxSelector, function() {
                        ...
                        if ($this.is(':checkbox')) {
                            ...
                            if (anyChecked && $this.val() && $this.val().toString().trim() !== '') {
                                ...
                                if ($this.is(':checked') && ($this.next('label').text().trim().toLowerCase() ===
                                        'khác' || $this.attr('class') && $this.attr('class').indexOf(
                                            'other') !== -1)) {
                                    $wrapper.show();
                                    ...
                                    const still = $(checkboxSelector).filter(function() {
                                        return ($(this).next('label').text().trim().toLowerCase() ===
                                            'khác' || $(this).hasClass('recruitment_type_other') ||
                                            $(this).hasClass('soft_skills_required_other') || $(
                                                this).hasClass('must_attended_courses_other') || $(
                                                this).hasClass('solutions_get_job_other'));
                            ...
                            if ($this.is(':checked') && ($this.next('label').text().trim().toLowerCase() ===
                                    'khác' || $this.hasClass('job_search_method_other'))) {
                                $wrapper.show();
                            } else {
                                $wrapper.hide();
                            }
