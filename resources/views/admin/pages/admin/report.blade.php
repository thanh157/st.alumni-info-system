                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered text-center align-middle"
                                ...
                                <tr>
                                    ...
                                    <th colspan="6">Tình hình việc làm</th>
                                ...
                                @php
                                    ...
                                    $totalCoViecLam = ($r1_trained_field->dung_nganh ?? 0) +
                                                      ($r1_trained_field->lien_quan ?? 0) +
                                                      ($r1_trained_field->khong_lien_quan ?? 0);

                                    // Tỷ lệ có việc làm / phản hồi
                                    $tyLeCoViecPhanHoi = $r1['total_res'] > 0 ? round($totalCoViecLam / $r1['total_res'] * 100, 2) : 0;

                                    // Tỷ lệ có việc làm / tốt nghiệp
                                    $tyLeCoViecTotNghiep = $r1['total_student'] > 0 ? round($totalCoViecLam / $r1['total_student'] * 100, 2) : 0;
                                @endphp
                                <tr>
                                    <td>1</td>
                                    <td></td>
