...
class ReportController extends Controller
{
    ...
    {
         [$report1, $students, $report3, $graduations, $selectedGraduationId, $survey, $schoolYear, $r1_trained_field, $r1_work_area, $studentTab2, $r2, $r1] = $this->getReportData($request, false);

         return Excel::download(new ReportExport($report1, $students, $report3, $schoolYear, $r1, $r1_trained_field, $r1_work_area, $r2, $studentTab2), 'bao-cao-viec-lam-sinh-vien.xlsx');
    }
}
